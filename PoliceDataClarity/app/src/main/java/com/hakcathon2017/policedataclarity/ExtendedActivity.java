 ...
 * under the License.
 * <p>
 * This class is an extension of the AppCompatActivity and is designed to make it easier to complete some common tasks within apps without much
 * effort.
 */
...
public abstract class ExtendedActivity extends AppCompatActivity {
	 ...
	 */
	protected static boolean viewHasNumber(TextView textView) {
		String text;
		double numText;
		try {
	 ...
	 */
	protected static double getViewDouble(TextView textView) {
	 ...
	 * A helper method to retrieve a double from a TextView.
	 */
	protected static int getViewInt(TextView textView) {
